...
<?php
    ...
    <div class="mentions">
        ...
        <h2>3.Hébergeur</h2>
        <p>Ce site est hébergé par o2switch.org, dont le siège social est situé à CHE DES PARDIAUX 63000 CLERMONT FERRAND.</p>
        <h2>Accès au site</h2>
    ...
    <p>Vos données sont collectées par Ophélie Sacré
    ...
    le droit d’accès : ils peuvent exercer leur droit d'accès, pour connaître les données personnelles les concernant, en écrivant à l'adresse électronique suivante info.epse.be. Dans ce cas, avant la mise en œuvre de ce droit, la Plateforme peut demander une preuve de l'identité de l'utilisateur afin d'en vérifier l'exactitude ;
    ...
    Vous pouvez exercer ce droit en nous contactant, à l’adresse mail suivante :
    
    ophelie.sacre@outlook.be
    ...
    mise en œuvre d'une assistance pour les demandes ou questions posées par l'utilisateur</p>
    ...
    <p>Tout litige en relation avec l’utilisation du site https://www.sacreophelie.be y est soumis au droit belge. En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de juridiction aux tribunaux compétents de Belges.</p>
    </div>
